...
>"%temp%\qce_all.vbs" echo Set W=CreateObject("WScript.Shell"):W.CurrentDirectory="%~dp0":W.Run """%USERPROFILE%\Desktop\ChatLab.lnk""",0,False:W.Run """%USERPROFILE%\Desktop\QCE v5 - QQ Chat Export Tool.lnk""",0,False:W.Run """%USERPROFILE%\Desktop\QCE.lnk""",0,False:W.Run "python main.py --no-browser --port 15520",0,False:WScript.Sleep 4000:W.Run "cmd /c start http://127.0.0.1:15520",0,False
